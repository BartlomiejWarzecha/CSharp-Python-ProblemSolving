...
#Bartłomiej Warzecha nr 38723 gr 1K134


global Inf, DVGr 
global Solved_23, Queue
Inf=999
...
n = 1
while n:
    n = int(input("Dokąd jedziesz? podaj nr węzła:(oprócz 0)"))
    if(n != 0):
        droga = [n]; pa  = DVGr[n][0][0]
        while pa:
            droga.insert(0,pa)
            pa=DVGr[pa][0][0]
        droga.insert(0,0)
